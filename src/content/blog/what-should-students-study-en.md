---
title: "What should you study in the age of AI? I don't have the answer either — so I thought it through"
description: "New-grad hiring is shrinking. What should a student study? I'm not sure either — the floor is Python and vibe coding (the new Word and Excel); the ceiling isn't credentials but solving a real problem with AI."
pubDate: 2026-07-02
...
- Entry-level hiring is shrinking (not solely because of AI, but not unrelated), and even stable professions — tax accountants, lawyers — reportedly have scarce internship spots. If you're just starting college or job-hunting now, it's daunting: *what should you study?* **Honestly, I'm not sure either. So I thought it through.**
- The **floor** seems clear — even for non-majors, **basic Python and vibe coding.** This is no longer "a developer's skill" but *a Word-and-Excel-grade basic.* If you'll work an office job, *being able to build a small tool yourself* has become a must.
- The **ceiling** isn't credentials. Grades and certificates matter, but **experience solving a real problem in your field with AI** matters more. Someone with a strong résumé gets overtaken by someone who *relentlessly improves their field with AI.*
- But there's a trap — **over-trusting AI.** *"What to build" you can discuss with AI, but "what to do with my life" you must decide yourself.* Distinguishing what to deliberate yourself from what to delegate — that may be the most important preparation of all.

> **About this piece.** This isn't a piece that pretends to know the answer. It's closer to a *bet* — pushing my own thinking, first person, on a question I'm genuinely unsure about (so strong lines like "always overtaken" are marked as my view). Same vein as [Build in studying](/en/blog/build-in-studying-en/) and [Who does AI replace](/en/blog/who-does-ai-replace-en/).
...
It's not just my idea. [Jensen Huang says the same](https://fortune.com/2026/04/22/jensen-huang-nvidia-ai-replace-workers-not-jobs/) — *"most people won't lose their job to AI; they'll lose it to someone who uses AI."* Surveys show employees who use AI are several times more likely to get promotions and raises. The direction already looks fairly clear.
...
- **Floor: Python + vibe coding are the new Word and Excel.** Even non-majors and office workers now need to build small tools themselves as a basic literacy.
- **Ceiling: not credentials but "having solved a problem in your field with AI."** A credential is a fixed proof of the past; AI use compounds — which is why the overtaking happens.
- **Execution: brainstorm *what* to build with AI too.** It needn't be grand — a trace of "I solved a real problem with AI" is enough.
- **Balance: know what *not* to delegate.** Direction, career, judgment are yours; problem-solving within them is AI's. Over-trusting AI means delegating your own life.
