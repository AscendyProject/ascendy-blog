---
title: "Defense Against the Dark Arts for the AI age — study philosophy"
description: "We delegate thinking to AI and accept it uncritically, making it easy to steer thought by baking in an ideology. Not hypothetical: some models already refuse topics. The defense: philosophy, and a 'devil's advocate.'"
pubDate: 2026-07-26
...
No need to be intimidated. You don't have to start with thick academic tomes. There are plenty of accessible philosophy books now. One I enjoyed is Shu Yamaguchi's [*How Philosophy Becomes a Weapon for Life*](https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=179428940) — the title itself says *"a weapon for life."* It organizes philosophy not as culture but as a *tool,* into 50 thinking frames, which makes it a good starting point.
...
I implement this in real work like so. When one AI model builds something, **a rival model from a different company** reviews the result *adversarially.* The model that wrote the code shares its own assumptions, so it can't see their blind spot; a model of a different family has no reason to agree with those assumptions. This is [cross-model verification](/en/blog/multi-agent-not-always-the-answer-en/) — and *the devil's advocate, engineered.*
...
I live [delegating most of my work to AI](/en/blog/i-didnt-design-it-i-delegated-en/). So it would be off to read this as "don't use AI." The opposite.
