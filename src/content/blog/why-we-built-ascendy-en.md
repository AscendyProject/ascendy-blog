...
What caught my eye in the pivot was the gap we wanted to close. The pieces were already appearing — in 2024 Google Photos shipped "Ask Photos," which went beyond natural-language search to curating highlights and generating captions for sharing. But **across everything we surveyed, we couldn't find a flow that tied finding, organizing, and sharing end-to-end into a single natural-language command.** The "ask in plain words and it just handles it" experience we'd all grown used to with GPT and Claude was missing from exactly the place our photos pile up the most.
