...
- Same for non-developers — just as developers manage code, you should *timestamp and keep a record* of what you make. Faked it? **It shows in the interview. If not the interview, then the internship.**
- The hiring criteria change. From *which school, which certificate, which company* → to **what this person actually *built*, and the data they've accumulated.** We couldn't process that data before; now agents can, fast and at scale.
...
"Couldn't you fake that too?" You could. But someone who filled an accumulated record with lies **shows it in the interview. If not the interview, then the internship.** Work alongside them for a month and the gap between the record and the reality can't hide.
...
**That constraint is dissolving.** Agents now process large volumes of data in a short time — reading, cross-checking, and organizing hundreds of applicants' accumulated records. The reason to lean on the *summary* is shrinking.

## It's already happening

This isn't far off. The Japanese AI company **Sakana AI** (founded by David Ha, ex–Google Brain, and Llion Jones, a co-author of the Transformer paper) uses a **month-long take-home** in hiring. Not a short coding test — *here's time, show us depth.* It **rewards depth over speed.**

From here it's my view: I think this is **the most fitting way to hire capable people in the AI era.** Not the verbal polish of a one-hour interview, but *what you actually build* over a month. The output, and the record of how it came to be, *is* the person.
